...
The main README stays high-level on purpose. For deep dives into specific topics:

### ⚙️ Core & Algorithms
* 🏗️ [**Architecture**](docs/architecture.md) — The decision engine priority ladder, filtration runtime formulas, and developer/testing setup.
* 📅 [**Planning & Optimisation**](docs/planning.md) — Maintenance vs. seasonal heating planning logic and dynamic price integrations.
* 🧠 [**Self-Learning Model**](docs/learning.md) — How the self-learning COP curve and thermal loss model adapt and validate session data.

### 🔌 Hardware & ESPHome
* 🛠️ [**Hardware Guide**](docs/hardware.md) — Bill of Materials (BOM), wiring overview, pinouts, and physical installation photos.
* ⚡ [**ESPHome Configuration**](docs/esphome.md) — Complete worked ESPHome YAML, local $\Delta T$/COP calculations, and probe/flow calibration guides.

### 💡 Extra's & Tips
* 📋 [**Pre-filling Defaults**](docs/defaults.md) — How to drop a `poolsmart_defaults.json` in your HA folder to pre-fill the wizard setup.
* 📊 [**Lovelace Examples**](docs/lovelace/) — Example dashboard YAML and card setups for everyday monitoring.
