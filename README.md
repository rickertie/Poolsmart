...
Every field has a help line underneath it explaining where to find the number and
giving a worked example. Water surface may be left blank; it is calculated from
volume and depth.
