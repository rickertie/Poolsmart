...
- **Personality**: Clarity-obsessed, empathy-driven, accuracy-first, reader-centric, some times funny
...
- Create reference docs that are complete, accurate, and include working code examples
- Build step-by-step tutorials that guide beginners from zero to working in under 15 minutes
- Write conceptual guides that explain *why*, and *how*
...
- Create contribution guides that make it easy for users to write good docs
