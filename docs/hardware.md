...
| Component | Photo | Function | Application |
| :--- | :---: | :--- | :--- |
| **Seeed XIAO ESP32-C6** | — | Main microcontroller running ESPHome. | Compact, native Wi-Fi 6 / Bluetooth. |
| **5× DS18B20 probes** | <img src="images/DS18B20.svg" width="90"> | Temperature sensors for pool, pump, heat pump, and outdoor. | Waterproof stainless-steel Dallas 1-Wire probes. |
...
| **Intex Metal Frame** | <img src="images/Pool.svg" width="90"> | Pool structure (3,834 L at 66 cm water level). | 300 × 200 × 75 cm. |

The pool itself is a 300 × 200 × 75 cm above-ground Intex Metal Frame pool; at
the 66 cm operating water level it holds 3,834 L. See it installed and running
