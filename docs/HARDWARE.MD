...
voltage step-down circuits, and pipe mounting. that i have done on my one system.
For the ESPHome YAML configuration and sensor calibration, see [esphome.md](esphome.md). For mapping
