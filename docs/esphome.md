...
see [Hardware](hardware.md). For mapping sensors to integration fields, see
[Sensors](sensors.md).
...
<p align="center">
  <img src="images/bucket-test-calibration.svg" width="500" alt="Flow Meter Calibration — Bucket Test setup">
</p>
...
- [Sensors](sensors.md) — Sensor mapping, probe calibration, and flow meter
  wiring.
...
- [Filtration](filtration.md) — How flow calibration affects filtration duration.
