...
see the [README](index.md). For the example defaults file, see
...
- [README](index.md) — Full installation walkthrough and configuration guide.
- [poolsmart_defaults.example.json](poolsmart_defaults.example.json) — Ready-made
  example file you can copy and edit.
- [Sensors](sensors.md) — How to map your sensors after setup.
- [Configuration](configuration.md) — How to change settings after initial setup.
- [Heating](heating.md) — Heating sources and their configuration options.
